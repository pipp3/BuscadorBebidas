                ...
                <DialogPanel className="relative transform overflow-hidden rounded-lg bg-fourth px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6">
                  ...
                  >
                    ...
                    <div className="mt-5 flex justify-between gap-4">
                      ...
                      <button onClick={()=>handleClickFavorite(selectedRecipe)} className="w-full rounded uppercase bg-[#38bdf8] text-fourth p-2 font-bold shadow hover:bg-[#0284c7]" type="button">Agregar a Favoritos</button>
                    </div>
                  </DialogTitle>
                </DialogPanel>
              </TransitionChild>
